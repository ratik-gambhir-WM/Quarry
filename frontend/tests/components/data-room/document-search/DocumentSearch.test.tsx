...
import DocumentSearch, { filterDocumentSearchItems } from "@/components/data-room/document-search/DocumentSearch";
import type { DocumentSearchItem } from "@/components/data-room/document-search/documentSearchModel";
