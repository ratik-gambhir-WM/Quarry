...
function PdfEditorModeSwitch({
  ...
  return (
    <div
      ...
      className="flex shrink-0 items-center gap-0.5 rounded-lg bg-surface-container-high p-0.5"
    >
      {options.map((option) => {
      ...
      >
        ...
        >
          ...
          >
              ...
              <TooltipProvider delay={TOOLTIP_DELAY_MS}>
                <fieldset disabled={controlsDisabled} className="contents">
                  ...
                  <div
                    ...
                    className="flex min-h-10 items-center gap-1 border-b bg-surface-container-low px-3 py-1.5"
                  >
                    <PdfEditorModeSwitch
                      mode={mode}
                      features={features}
            ...
            <div
              ref={shellRef}
              className="relative flex min-h-0 flex-1 overflow-hidden bg-surface-container"
            >
              <PdfEditorWorkspace
...
function InlineScrollArea2({
  ...
  return (
    ...
    >
      ...
      {orientation !== "horizontal" ? (
        <InlineScrollBar orientation="vertical" />
      ) : null}
      {orientation !== "vertical" ? (
        <InlineScrollBar orientation="horizontal" />
      ) : null}
...
type InlineScrollAreaProps = Omit<ScrollAreaPrimitive.Root.Props, "style"> & {
