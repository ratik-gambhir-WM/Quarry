    ...
    <>
      ...
      <WorkspaceCard className="relative min-h-[680px] overflow-hidden p-8" radius="compact">
        <DealRoomViewIntro
          ...
          description="A working graph for connecting documents, findings, risks, and recommendations across the diligence process."
          eyebrow="Diligence Graph"
          title={`${deal.name} Knowledge Map`}
        />
