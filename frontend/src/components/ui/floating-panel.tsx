      ...
      >
        <ArkFloatingPanel.Content
          className={cn(
            ...
            "text-on-surface",
            "rounded-2xl border border-outline-variant shadow-[var(--theme-panel-shadow)] outline-none",
    ...
    <FloatingPanelDragTrigger>
      <ArkFloatingPanel.Header
        className={cn(
          ...
          "rounded-t-2xl border-b border-outline-variant/70",
          "overflow-hidden",
...
type FloatingPanelStageTriggerProps = Omit<
...
export const FloatingPanelResizeTrigger = (
  ...
  const axisClassName = {
    n: "-top-1 right-2 left-2 h-2",
    e: "-right-1 top-2 bottom-2 w-2",
    s: "-bottom-1 right-2 left-2 h-2",
    w: "-left-1 top-2 bottom-2 w-2",
    ne: "-top-1 -right-1 size-3",
    se: "-right-1 -bottom-1 size-3",
    sw: "-bottom-1 -left-1 size-3",
    nw: "-top-1 -left-1 size-3",
  }[axis];
  ...
  return (
    <ArkFloatingPanel.ResizeTrigger
      axis={axis}
      className={cn(
        "z-10 data-disabled:pointer-events-none",
        axisClassName,
        className,
      )}
  ...
  return (
    <ark.div
      className={cn(
        ...
        "px-(--space) py-4",
        "bg-surface-container-low/70",
        "border-t border-outline-variant/70",
        className
      )}
