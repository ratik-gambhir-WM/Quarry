...
pub use crate::domains::documents::store::sqlite::DealDocumentSummary;
...
impl StoredDocumentService {
    pub fn new(files: DocumentStore, office: OfficeConverter) -> Self {
        Self {
            files,
            office,
...
#[cfg(test)]
#[path = "../../../../tests/unit/domains/documents/viewing/service_tests.rs"]
mod tests;
