...
use crate::domains::documents::model::{Document as IngestionDocument, DocumentChunk};
use crate::shared::ids::document_id_from_content;
use crate::{
    adapters::openai::client::OpenAiClient,
    domains::documents::formats::{image::describe_image, text_chunking::token_bounded_ranges},
};
...
#[cfg(test)]
#[path = "../../../../tests/unit/domains/documents/formats/pdf_tests.rs"]
mod tests;
